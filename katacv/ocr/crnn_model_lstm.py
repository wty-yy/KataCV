# -*- coding: utf-8 -*-
'''
@File    : crnn_model_lstm.py
@Time    : 2023/10/16 21:49:24
@Author  : wty-yy
@Version : 1.0
@Blog    : https://wty-yy.space/
@Desc    : 
Use LSTM, ResBlock struct. Val accuracy: 88%
'''
...
def get_ocr_crnn_lstm_state(args: OCRArgs, verbose=False) -> TrainState:
...
if __name__ == '__main__':
    ...
    state = get_ocr_crnn_lstm_state(args, verbose=True)
