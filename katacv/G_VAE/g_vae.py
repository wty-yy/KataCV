...
if __name__ == '__main__':
  ...
  # args, writer = get_args_and_writer(model_name='G-VAE', dataset_name='celeba')
  args, writer = get_args_and_writer(model_name='G-VAE', dataset_name='celeba', use_unet=True)
  ...
  if not args.use_unet:
    ...
    from katacv.G_VAE.model_unet import get_g_vae_model_state
