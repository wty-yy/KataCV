...
from katacv.yolov4.csp_darknet53 import PreTrain, CSPDarkNet  # change
...
if __name__ == '__main__':
  ...
  state = get_model_state(PreTrain(darknet=CSPDarkNet([1,2,8,8,4])), args=get_args_and_writer("CSPDarkNet53", no_writer=True))  # change
  full_path = args.path
