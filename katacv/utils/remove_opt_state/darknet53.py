...
from katacv.yolov3.darknet53 import get_pretrain_state, get_args_and_writer  # change

def parse_args():
    from katacv.utils.parser import argparse, cvt2Path
    parser = argparse.ArgumentParser()
    parser.add_argument("--path", type=cvt2Path, default="/home/yy/Coding/models/YOLOv3/DarkNet53-0050",
...
if __name__ == '__main__':
    ...
    state = get_pretrain_state(get_args_and_writer(no_writer=True))  # change
