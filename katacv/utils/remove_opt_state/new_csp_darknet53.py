...
from katacv.utils.imagenet.train import get_args_and_writer, get_model_state
from katacv.yolov5.new_csp_darknet53 import PreTrain, CSPDarkNet  # change

def parse_args():
  from katacv.utils.parser import argparse, cvt2Path
  parser = argparse.ArgumentParser()
  parser.add_argument("--path", type=cvt2Path, default="/home/yy/Coding/GitHub/KataCV/logs/NewCSPDarkNet53-checkpoints/NewCSPDarkNet53-0050",  # change
...
if __name__ == '__main__':
  ...
  state = get_model_state(PreTrain(darknet=CSPDarkNet()), args=get_args_and_writer("NewCSPDarkNet53", no_writer=True))  # change
  full_path = args.path
